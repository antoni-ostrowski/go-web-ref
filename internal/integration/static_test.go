...
func TestStatic_ServesVendoredJS(t *testing.T) {
	...
	rec := Do(t, app, http.MethodGet, "/static/js/htmx.min.js", nil, nil, nil)
...
func TestStatic_NoListingNoTraversal(t *testing.T) {
	...
	rec := Do(t, app, http.MethodGet, "/static/js/", nil, nil, nil)
	WantCode(t, rec, http.StatusNotFound)

	rec = Do(t, app, http.MethodGet, "/static/../go.mod", nil, nil, nil)
